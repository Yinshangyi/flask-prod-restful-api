...
class Nested(Raw):
    ...
    :param dict model: The models dictionary to nest
...
class Polymorph(Nested):
    ...
    .. code-block:: python
        ...
        fields = api.models('Thing', {
            owner: fields.Polymorph(mapping)
        })

    :param dict mapping: Maps classes to their models/fields representation
    '''
    ...
    def clone(self, mask=None):
        ...
        for field in ('allow_null', 'models'):
            data.pop(field, None)
