...
class ModelBase(object):
    ...
    :param str name: The models public name
    '''
    ...
    def inherit(cls, name, *parents):
        '''
        Inherit this models (use the Swagger composition pattern aka. allOf)
        :param str name: The new models name
        :param dict fields: The new models extra fields
        '''
...
class Model(ModelBase, OrderedDict, MutableMapping):
    ...
    :param str name: The models public name
    :param str mask: an optional default models mask
    '''
    ...
    def resolved(self):
        ...
        # Ensure discriminator always output the models name
    ...
    def extend(self, name, fields):
        '''
        Extend this models (Duplicate all fields)
    ...
    def clone(cls, name, *parents):
        ...
        >>> models = Model.clone(fields_1, fields_2)

        or from an Instanciated models

        >>> new_model = models.clone(fields_1, fields_2)

        :param str name: The new models name
        :param dict parents: The new models extra fields
        '''
        fields = OrderedDict()
