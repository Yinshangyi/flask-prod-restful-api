...
class Namespace(object):
    ...
    def extend(self, name, parent, fields):
        '''
        Extend a models (Duplicate all fields)
    ...
    def clone(self, name, *specs):
        '''
        Clone a models (Duplicate all fields)

        :param str name: the resulting models name
    ...
    def expect(self, *inputs, **kwargs):
        '''
        A decorator to Specify the expected input models

        :param ModelBase|Parse inputs: An expect models or request parser
    ...
    def response(self, code, description, model=None, **kwargs):
        ...
        :param ModelBase model: an optional response models
